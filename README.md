...
6. If you want your top plays from a mode thats not standard, change line 55 of main.py to whatever mode you want.
7. In file explorer, go into the folder where you put main.py, and click on the bar that shows your file path which is above all your files. Click on this, and type cmd.
8. In cmd, type: pip install requests
9. Then type: python main.py
10. It will start downloading your top plays (it's a bit slow) and it will put it into a downloads folder inside the folder where main.py is.
